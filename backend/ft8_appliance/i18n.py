...
_DE: dict[str, str] = {
    ...
    "push.power_over_cap_title": "⚠️ Sendeleistung am Gerät zu hoch",
    "push.power_over_cap_msg": "{model} steht auf {rig} W, erlaubt sind {legal} W. Bitte am Gerät reduzieren — die Appliance kann die Leistung bei diesem Rig nicht setzen.",
    "push.monatspruefung_title": "📊 FT8 Pi: Monatsprüfung der Auswahllogik",
    "push.monatspruefung_kontrolle": "Kontrollarm gegen Regel (QSOs je Stunde, 30 Tage):",
    "push.monatspruefung_regeln": "Regeln ohne gültigen Beleg",
    "push.monatspruefung_zeit": "Ausbeute je Betriebsstunde:",
...
_EN: dict[str, str] = {
    ...
    "push.daily_bestdx": "⭐ Best DX: {call} ({grid})",
    "push.power_over_cap_title": "⚠️ TX power at the rig too high",
    "push.power_over_cap_msg": "{model} is set to {rig} W, {legal} W allowed. Please reduce at the rig — the appliance cannot set power on this model.",
    "push.monatspruefung_title": "📊 FT8 Pi: monthly review of the picker logic",
    "push.monatspruefung_kontrolle": "Control arm vs. rules (QSOs per hour, 30 days):",
    "push.monatspruefung_regeln": "Rules without valid evidence",
    "push.monatspruefung_zeit": "Yield per operating hour:",
