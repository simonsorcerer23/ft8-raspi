...
| Dritte Decoderstufe | WSJT-X' eigener `jt9` (Paket `wsjtx`) als Unterprozess auf der Slot-WAV (`/dev/shm`), Tiefe 2, parallel zu Stufe 2, Ergebnisse über den Nachreich-Pfad | den Fortran-Decoder portieren | GPL bleibt außerhalb unseres MIT-Codes; am Pi 4B 6 s (max 9 s) pro Slot, allein 97,5 % der WSJT-X-Decodes, mit Stufe 2 98,3 % plus ~50 Decodes, die die Referenz nicht hat; Tiefe 3 bräuchte 11–17 s (2026-09-08) |
