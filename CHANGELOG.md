...
## v0.169.2 — 2026-09-18
- fix: eQSL-Posteingang stuendlich statt zweimal am Tag abgleichen — neue Karten hingen bis zu 12 h, ehe sie auf dk9xr.de erschienen
...
## v0.155.0 — 2026-09-14
- fix: p_cq-Messung abgeschaltet — sie zaehlte fremde Erfolge als CQ-Ertrag
...
## v0.145.0 — 2026-09-14
- feat: Schwelle fuer schwache Ziele adaptiv und wertabhaengig

## v0.144.0 — 2026-09-14
- fix: Konfigurations-Neuladen loeste Manipulationsalarm fuer die Sendeleistung aus
...
- docs: context_health-Zahlen gelten je Slot, nicht kumuliert
...
## v0.127.0 — 2026-09-12
- fix: Hotspot springt nicht mehr nach einer Minute Aussetzer an
...
## v0.99.1 — 2026-09-11
- fix: Vorab-Decode-Statistik wurde vom regulaeren Durchgang geloescht
...
## v0.95.0 — 2026-09-11
- fix: PSK-Liste ueberlebt den Neustart

## v0.94.0 — 2026-09-11
- fix: gelernte Slot-Paritaeten ueberleben den Neustart
- docs: Lesart der Datenbasis-Anzeige klarstellen

## v0.93.0 — 2026-09-11
- fix: Picker-Kontext stammte aus den Decodes des vorigen Slots
...
## v0.90.0 — 2026-09-11
- fix: Doppel-QSOs durch zu kurzen Erfolgs-Cooldown
- docs: Begruendung des Paritaets-Fixes richtiggestellt
...
## v0.87.1 — 2026-09-10
- fix: Empfangsabfrage pausierte dauerhaft, seit CQ und Hunting zusammen laufen
- tools: qso_bilanz.py — Abschlussquoten nach Weg, Kennzahl der Sequenz-Loecher

## v0.87.0 — 2026-09-10
- fix: Wunschliste erreicht den Picker, Telemetrie erfasst eingehende Anrufe
...
## v0.82.3 — 2026-09-08
- fix: decoded.txt war versehentlich eingecheckt; Self-Update raeumt Laufzeit-Artefakte weg
...
## v0.66.13 — 2026-06-15
- fix: escape weak ft4 probes after dwell
...
## v0.66.9 — 2026-06-14
- fix: relax PSK Reporter query timeout
...
## v0.66.6 — 2026-06-14
- fix: reconcile boot dial after rig becomes ready
